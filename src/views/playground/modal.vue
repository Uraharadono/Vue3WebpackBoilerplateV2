<template>
	<div>
		<ModalComponent v-if="isModalVisible" :modal-size="'large'" :teleport-disabled="true">
			...
			<template #footer>
				<button type="button" class="btn btn-warning" @click="toggleModalVisibility">Close</button>
			</template>
		</ModalComponent>
