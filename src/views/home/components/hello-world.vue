<template>
	<div class="hello">
		...
		<h1 v-html="msg"></h1>
		<h5>
			Improved version of Vue 3 boilerplate using <strong>WebPack</strong> to handle building of
			project.
		</h5>

		<div class="container">
			<hr />
			<h4>List of components/libraries/possibilities:</h4>
			<div class="row">
				<div class="col">
					<div class="alert alert-primary" role="alert">Libraries</div>
